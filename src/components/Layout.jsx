...
const Layout = ({ children }) => {
    ...
    <header className="sticky top-0 z-50 border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60 shadow-sm">
      ...
      <div className="flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          {/* User Info */}
          <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted text-xs sm:text-sm">
  ...
  {/* Main Content */}
  <main className="mx-auto max-w-5xl px-3 sm:px-4 lg:px-6 py-6 pb-6">
    {children}
  </main>
</div>
