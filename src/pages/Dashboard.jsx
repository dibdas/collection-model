      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Overview of your debt collection operations
          </p>
        </div>
        ...
        <div className="grid gap-2 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Distribution of cases across different stages
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  {
                    action: "Case CS001 updated",
                    time: "2 minutes ago",
                    type: "update",
                  },
                  {
                    action: "Payment received CS003",
                    time: "15 minutes ago",
                    type: "payment",
                  },
                  {
                    action: "New case assigned CS005",
                    time: "1 hour ago",
                    type: "assigned",
                  },
                  {
                    action: "Legal notice sent CS004",
                    time: "2 hours ago",
                    type: "legal",
                  },
                ].map((activity, i) => (
